    ...
    <div className="App">
      ...
      <div className='vision_3d'>
        ...
        <div className='submit_form'> 
          ...
          Чтобы получить подробную консультацию,<br/>
оставьте своё имя и номер телефона,<br/>
